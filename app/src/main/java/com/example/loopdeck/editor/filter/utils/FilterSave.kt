package com.example.loopdeck.editor.filter.utils
...
enum class FilterSave {
    ...
    companion object {
        ...
        fun createFilterList(): List<FilterSave> {
            val filters = ArrayList<FilterSave>()
        ...
        fun createGlFilter(filterType: FilterSave, context: Context?): GlFilter {
            when (filterType) {
