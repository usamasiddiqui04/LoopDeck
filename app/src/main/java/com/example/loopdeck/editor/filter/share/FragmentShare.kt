package com.example.loopdeck.editor.filter.share
...
import com.example.loopdeck.editor.filter.utils.MotionTouchListener
...
class FragmentShare : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(uri: String): FragmentShare {
            val fragment = FragmentShare()
            val bundle = Bundle()
