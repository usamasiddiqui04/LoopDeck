...
class FastScrollRecyclerView @JvmOverloads constructor(
    ...
    private fun handleTouchEvent(ev: MotionEvent): Boolean {
        ...
        when (action) {
            ...
            MotionEvent.ACTION_UP, MotionEvent.ACTION_CANCEL -> mScrollbar.handleTouchEvent(
                ev,
                mDownX,
                mDownY,
                mLastY,
    ...
    private fun updateThumbPosition(
        scrollPosState: ScrollPositionState,
        rowCount: Int,
        yOffset: Int
    ) {
        val availableScrollHeight =
        ...
        val scrollY =
            paddingTop + yOffset + scrollPosState.rowIndex * scrollPosState.rowHeight - scrollPosState.rowTopOffset
        val scrollBarY =
            (scrollY.toFloat() / availableScrollHeight * availableScrollBarHeight).toInt()
    ...
    private fun updateThumbPositionWithMeasurableAdapter(
        scrollPosState: ScrollPositionState,
        yOffset: Int
    ) {
    ...
    fun scrollToPositionAtProgress(touchFraction: Float): String {
        ...
        layoutManager.scrollToPositionWithOffset(
            spanCount * exactItemPos / mScrollPosState.rowHeight,
