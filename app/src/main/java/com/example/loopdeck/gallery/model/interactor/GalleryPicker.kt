...
import com.example.loopdeck.gallery.model.GalleryImage
import com.example.loopdeck.gallery.model.GalleryVideo
import java.io.File
...
class GalleryPicker(var ctx: Context) {
    ...
    fun getVideos(): ArrayList<GalleryVideo> {
        ...
        try {
            if (isReadWritePermitted()) {
                ...
                val videocursor =
                    ctx.contentResolver.query(videoQueryUri, videoProjection, null, null, null)
                ...
                if (videocursor != null && videocursor.count > 0) {
                    if (videocursor.moveToFirst()) {
                        do {
                            ...
                            video.DATE_ADDED =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.DATE_ADDED))
                            video.DATE_MODIFIED =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.DATE_MODIFIED))
                            video.DISPLAY_NAME =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.DISPLAY_NAME))
                            video.HEIGHT =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.HEIGHT))
                            video.MIME_TYPE =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.MIME_TYPE))
                            video.SIZE =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.SIZE))
                            video.TITLE =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.TITLE))
                            video.WIDTH =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.WIDTH))
                            video.ALBUM =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.ALBUM))
                            video.ARTIST =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.ARTIST))
                            video.BOOKMARK =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.BOOKMARK))
                            video.BUCKET_DISPLAY_NAME =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.BUCKET_DISPLAY_NAME))
                            video.BUCKET_ID =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.BUCKET_ID))
                            video.CATEGORY =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.CATEGORY))
                            video.DATE_TAKEN =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.DATE_TAKEN))
                            video.DESCRIPTION =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.DESCRIPTION))
                            video.DURATION =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.DURATION))
                            video.IS_PRIVATE =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.IS_PRIVATE))
                            video.LANGUAGE =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.LANGUAGE))
                            video.LATITUDE =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.LATITUDE))
                            video.LONGITUDE =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.LONGITUDE))
                            video.MINI_THUMB_MAGIC =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.MINI_THUMB_MAGIC))
                            video.RESOLUTION =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.RESOLUTION))
                            video.TAGS =
                                videocursor.getString(videocursor.getColumnIndex(MediaStore.Video.Media.TAGS))
    ...
    private fun isReadWritePermitted(): Boolean =
        (ctx.checkCallingOrSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED && ctx.checkCallingOrSelfPermission(
