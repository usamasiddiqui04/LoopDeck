...
import com.xorbics.loopdeck.gallery.presenter.VideosPresenterImpl
import com.xorbics.loopdeck.gallery.utils.MLog
import com.xorbics.loopdeck.gallery.utils.RunOnUiThread
import com.xorbics.loopdeck.gallery.utils.font.FontsConstants
import com.picker.gallery.utils.font.FontsManager
import com.xorbics.loopdeck.gallery.utils.keypad.HideKeypad
import com.xorbics.loopdeck.gallery.view.adapters.AlbumAdapter
import com.xorbics.loopdeck.gallery.view.adapters.VideoGridAdapter
...
class VideosFragment : Fragment(), ImagePickerContract {
                ...
                override fun onComplete(albums: ArrayList<GalleryAlbums>) {
                    ...
                    RunOnUiThread(ctx).safely {
                        ...
                        initRecyclerViews()
                            ...
                            (ctx as PickerActivity).setResult(
                                (ctx as PickerActivity).REQUEST_RESULT_CODE,
                                i
                            )
    ...
    override fun initRecyclerViews() {
        ...
        imageGrid.adapter = VideoGridAdapter(
            imageList = photoList,
