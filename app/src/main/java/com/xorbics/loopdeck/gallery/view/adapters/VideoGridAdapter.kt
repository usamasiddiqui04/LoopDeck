package com.xorbics.loopdeck.gallery.view.adapters
...
import com.xorbics.loopdeck.gallery.utils.DateUtil
import com.xorbics.loopdeck.gallery.utils.MLog
import com.xorbics.loopdeck.gallery.utils.RunOnUiThread
import com.xorbics.loopdeck.gallery.utils.scroll.FastScrollRecyclerView

class VideoGridAdapter() : RecyclerView.Adapter<VideoGridAdapter.MyViewHolder>(),
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (mimageList[holder.adapterPosition].mediaType == MediaStore.Files.FileColumns.MEDIA_TYPE_VIDEO) {
            ...
            holder.durationLabel.text =
                DateUtil().millisToTime(mimageList[holder.adapterPosition].duration.toLong())
