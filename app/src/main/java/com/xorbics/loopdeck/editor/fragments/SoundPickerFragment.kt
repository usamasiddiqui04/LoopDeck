...
class SoundPickerFragment : BottomSheetDialogFragment() {
    ...
    private lateinit var addMusicListener: com.xorbics.loopdeck.editor.fragments.AddMusicFragment.AddMusicFragmentListener

    companion object {
        fun newInstance(
            soundPickerListener: SoundPickerListener,
            musicListener: com.xorbics.loopdeck.editor.fragments.AddMusicFragment.AddMusicFragmentListener,
