...
import com.xorbics.loopdeck.editor.filter.utils.FileUtils
...
class FilterMainActivity : AppCompatActivity() {
    ...
    private var permissionsCamera: Array<String> = arrayOf(
        Manifest.permission.CAMERA,
        Manifest.permission.WRITE_EXTERNAL_STORAGE
    )

    private var permissionsPickGallery: Array<String> = arrayOf(
